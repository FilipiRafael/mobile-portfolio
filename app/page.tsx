  ...
  return (
    <main className="relative isolate flex min-h-screen flex-col items-center justify-between p-12 overflow-hidden">
      ...
      <div className="h-full flex flex-col items-center justify-center space-y-12 md:space-y-0">
        <h1 className="text-8xl md:text-9xl dark:text-white text-center font-black tracking-tighter">
          Filipi Rafael
        </h1>
        <h2 className="text-5xl md:text-6xl text-black/80 dark:text-white/80 text-center font-extrabold mt-6 tracking-tighter">
          Mobile Software Engineer | React Native
        </h2>

        <div className="w-full flex flex-col md:flex-row justify-between align-center mt-6">
          <h2 className="text-2xl md:text-3xl dark:text-white text-center font-light tracking-tighter">
            Mobile Engineer.
          </h2>
          <h2 className="text-2xl md:text-3xl dark:text-white text-center font-light tracking-tighter">
      ...
      <div className="w-full flex flex-row space-x-4 justify-center items-center mt-6">
        <a
          ...
          <svg
            ...
            height="32"
            viewBox="0 0 32 32"
            className="fill-black dark:fill-white w-16 md:w-24 h-16 md:h-24 rounded-full cursor-pointer"
